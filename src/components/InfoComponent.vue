        ...
        <div class="row justify-center q-pa-md">
            ...
            >
                ...
                <div class="row">
                    ...
                    <q-btn @click="createInfo" :disable="!isCreateAvailable" label="Create" color="primary" class="col q-ml-sm"/> 
                    <q-btn @click="editInfo" :disable="isCreateAvailable" label="Edit" color="primary" class="col q-ml-sm"/>
                    <q-btn @click="deleteInfo" :disable="isCreateAvailable" label="Delete" color="primary" class="col q-ml-sm "/>
                </div>

                <q-list 
                    class="row" style="width: 20vmax; color: red"
                >
